 ...
 */
function devchallenge_cta_button_shortcode( $atts, $content = null ) {
...
add_shortcode( 'cta_button', 'devchallenge_cta_button_shortcode' );
add_shortcode( 'devchallenge_button', 'devchallenge_cta_button_shortcode' );
add_shortcode( 'devchallenge_btn', 'devchallenge_cta_button_shortcode' );
