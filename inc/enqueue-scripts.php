...
function devchallenge_scripts() {
	...
	$template_uri = get_stylesheet_uri();
 	...
 	wp_enqueue_style( 'devchallenge-style', $template_uri, array(), _S_VERSION );
 	wp_style_add_data( 'devchallenge-style', 'rtl', 'replace' );
	 ...
	 */
	// Skip Link Focus
	wp_enqueue_script( 'devchallenge-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), _S_VERSION, true );
	...
	// Theme Scripts
	wp_register_script( 'devchallenge-js', get_template_directory_uri() . '/js/devchallenge.js', array('jquery'), NULL, true );
	wp_enqueue_script( 'devchallenge-js' );

}
add_action( 'wp_enqueue_scripts', 'devchallenge_scripts' );

/**
 * Dequeue WordPress default scripts
 */
function devchallenge_default_scripts( $scripts ) {
...
add_action( 'wp_default_scripts', 'devchallenge_default_scripts' );
